...
link-citations: yes # Referencias cruzadas a las citas
#csl: apa7.csl #https://www.zotero.org/styles?q=apa
#csl: the-plant-journal.csl
csl: apa-annotated-bibliography.csl # un tipo de style apa 7th edicion
...
- \usepackage{geometry} 
- \usepackage{helvet}
- \usepackage{amsmath} # Agregados por Fer
- \usepackage{amssymb} # Agregados por Fer
- \usepackage{gensymb} # Agregados por Fer
- \usepackage{caption} # Agregados por Fer
- \captionsetup[table]{name=\textbf{Tabla}} # Editado AYR (Tabla en negrita)
- \captionsetup[figure]{name=\textbf{Figura}} # Editado AYR (Figura en negrita)
- \pagestyle{fancy}
...
```{r PRIMER PASO CORRE MODELOS BASE, eval=FALSE, echo=FALSE, warning=FALSE, include=F}
setwd(dir.1)
...
\begin{figure}[htb!]
 ...
 \caption{Distribución espacial del langostino amarillo y área donde se desarrolla la actividad pesquera.}
 \label{f1}
\end{figure}
```
...
Como se observa, en la (**Figura \ref{f1}**), los desembarques bla bla bla


El langostino amarillo se distribuye sobre la plataforma continental de Chile y talud superior desde los 23°00' LS hasta los 38°20' LS (**Figura \ref{f1}**) y entre los veriles de 150 m a 400 m de profundidad [@Bahamonde2003_1]. Otros autores han descrito que este recurso se caracteriza por presentar densas agrupaciones o focos de concentración variables interanualmente [@Canales2012_1], y que presenta hábitos demersales, viviendo en fondos de grava y fango y ocasionalmente en los márgenes de zonas rocosas [@Ahumada2013_1].
